...
export const Settings = forwardRef<HTMLFormElement, Settings>(
  ({ onClose, ...params }, forwardedRef) => {
        ...
        <form {...params} onSubmit={handleSubmit(onSubmit)} ref={forwardedRef}>
          ...
          <FormSection title="Other">
            ...
            <div className="mb-2.5 flex select-none items-center justify-between text-neutral-500">
              ...
              <SwitchTransition>
                <Fade key={totalTimeToFocus} speed="faster">
          ...
          <FormSection title="Danger zone">
            <IconContext.Provider value={{ size: "1em" }}>
              <SwitchTransition>
                <Fade key={Number(confirmRestore)} speed="faster">
                  {!confirmRestore ? (
                    <p
